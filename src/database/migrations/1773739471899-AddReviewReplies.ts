...
export class AddReviewReplies1773739471899 implements MigrationInterface {
    name = 'AddReviewReplies1773739471899'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "reviewdb"."traveler_reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "traveler_id" uuid NOT NULL, "reviewer_id" uuid NOT NULL, "booking_id" uuid, "rating" smallint NOT NULL, "review_text" text, "reviewer_name" character varying(255), "status" character varying NOT NULL DEFAULT 'PENDING', "is_verified" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_a24cca37cb86d77a9c00d2843bf" UNIQUE ("traveler_id", "reviewer_id"), CONSTRAINT "PK_3c2cf6b45e1bfe37293ec0c152e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_traveler_reviews_booking_id" ON "reviewdb"."traveler_reviews" ("booking_id") `);
        await queryRunner.query(`CREATE INDEX "idx_traveler_reviews_created_at" ON "reviewdb"."traveler_reviews" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "idx_traveler_reviews_reviewer" ON "reviewdb"."traveler_reviews" ("reviewer_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "idx_review_replies_review_id" ON "reviewdb"."review_replies" ("review_id") `);
        await queryRunner.query(`CREATE TABLE "reviewdb"."provider_reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "provider_id" uuid NOT NULL, "reviewer_id" uuid NOT NULL, "booking_id" uuid, "rating" smallint NOT NULL, "review_text" text, "reviewer_name" character varying(255), "status" character varying NOT NULL DEFAULT 'PENDING', "is_verified" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_419c09b62741a94689d3037bb08" UNIQUE ("provider_id", "reviewer_id"), CONSTRAINT "PK_d61b668c24910d63eb0ccffc90d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_provider_reviews_booking_id" ON "reviewdb"."provider_reviews" ("booking_id") `);
        await queryRunner.query(`CREATE INDEX "idx_provider_reviews_created_at" ON "reviewdb"."provider_reviews" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "idx_provider_reviews_reviewer" ON "reviewdb"."provider_reviews" ("reviewer_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_provider_reviews_reviewer"`);
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_provider_reviews_created_at"`);
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_provider_reviews_booking_id"`);
        await queryRunner.query(`DROP TABLE "reviewdb"."provider_reviews"`);
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_review_replies_review_id"`);
        ...
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_traveler_reviews_reviewer"`);
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_traveler_reviews_created_at"`);
        await queryRunner.query(`DROP INDEX "reviewdb"."idx_traveler_reviews_booking_id"`);
        await queryRunner.query(`DROP TABLE "reviewdb"."traveler_reviews"`);
    }
